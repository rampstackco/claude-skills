...
- Use `brand-strategy` or `brand-discovery` for brand positioning, audience, and voice work. A logo without strategy is a drawing.
...
- **Monogram.** Multiple letters combined as a symbol. CN (Chanel), GG (Gucci), HBO, AC (a hypothetical Atlas Coffee monogram). Common in legal, financial, hospitality, and heritage brands. Can read as initials or as ligature.
